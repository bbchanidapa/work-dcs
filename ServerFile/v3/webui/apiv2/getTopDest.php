...
$select_inbound_query = "select * from device_topip_inbound where dt_id = (select dt_id from device_time order by dt_id desc LIMIT 0,1) LIMIT 0,10";
$result_inbound_query = mysql_query($select_inbound_query);
...
$dataCount = 0;
while($array_inbound_query = mysql_fetch_array($result_inbound_query))
{
	$array_mode[$dataCount] = $array_inbound_query['tin_mode'];
	$array_email[$dataCount] = $array_inbound_query['tin_email'];
	$array_hostname[$dataCount] = $array_inbound_query['tin_hostname'];
	$array_mac[$dataCount] = $array_inbound_query['tin_mac'];
	$array_comid[$dataCount] = $array_inbound_query['tin_cid'];
	$array_room[$dataCount] = $array_inbound_query['tin_room'];
	$array_name[$dataCount] = $array_inbound_query['tin_name'];
	$array_ip[$dataCount] = $array_inbound_query['tin_ip'];
	$array_totalocet[$dataCount] = $array_inbound_query['tin_totalusage'];
	$array_currentocet[$dataCount] = $array_inbound_query['tin_current'];
	$dataCount++;
